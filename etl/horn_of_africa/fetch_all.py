#!/usr/bin/env python3
"""Fetch all data for Horn of Africa region."""
import pathlib
import pandas as pd
import sys
...
iso3 = ["ETH", "SOM", "DJI", "ERI", "KEN", "SSD"]

print("[ETL:horn_of_africa] Fetching admin1 boundaries...")
try:
...
print("[ETL:horn_of_africa] Fetching UNHCR refugee stocks...")
frames = []
for o in iso3:
    for d in iso3:
        if o == d:
...
print("[ETL:horn_of_africa] Fetching ACLED events...")
...
print("[ETL:horn_of_africa] Building node features...")
try:
    import geopandas as gpd
...
print("✓ ETL complete for horn_of_africa")
